...
import ink.fdq.snowy.core.service.SysRescService;
import ink.fdq.snowy.core.vo.json.Menu;

import java.util.List;

public class AdminMenuService {
    private SysRescService sysRescService = new SysRescService();
    ...
    public Menu getAdminMenu(){
        ...
        List<SysResc> rescList = sysRescService.findByPid(1);
