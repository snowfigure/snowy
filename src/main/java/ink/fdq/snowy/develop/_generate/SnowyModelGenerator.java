package ink.fdq.snowy.develop._generate;
...
public class SnowyModelGenerator {
    ...
    public static void main(String[] args){
        ...
        /** base model 所使用的包名 */
        String baseModelPackageName = "ink.fdq.snowy.core.model.table.base";
        /** base model 文件保存路径 */
        String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/ink/fdq/snowy/core/model/table/base";

        /** model 所使用的包名 (MappingKit 默认使用的包名) */
        String modelPackageName = "ink.fdq.snowy.core.model.table";
