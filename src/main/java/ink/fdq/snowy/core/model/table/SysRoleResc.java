...
import ink.fdq.snowy.core.model.table.base.BaseSysRoleResc;
...
public class SysRoleResc extends BaseSysRoleResc<SysRoleResc> {
	...
	public static final SysRoleResc dao = new SysRoleResc().dao();

	/**
     * 查询所有数据（不建议使用）
     * @return
     */
    public List<SysRoleResc> findAll(){
     ...
     * @return
     */
    public Page<SysRoleResc> paginate(int pageNumber, int pageSize) {
